...
***************************************************************************** */
        ...
        function initializeClock(clock, endtime) {
            let hours = clock.querySelector(".timer-nft__hours");
            let minutes = clock.querySelector(".timer-nft__minutes");
            let seconds = clock.querySelector(".timer-nft__seconds");
        ...
        const itemCreators = document.querySelectorAll(".item-creator");
        if (itemCreators.length > 0) itemCreators.forEach(((itemCreator, index) => {
            const itemCreatorNumber = itemCreator.querySelector(".item-creator__number");
            itemCreatorNumber.innerHTML = index + 1;
        }));
        const artistPageButtons = document.querySelectorAll(".filter-atrist-page__button");
        if (artistPageButtons.length > 0) artistPageButtons.forEach((artistPageButton => {
            artistPageButton.addEventListener("click", (function(e) {
                artistPageButtons.forEach((artistPageButton => {
                    artistPageButton.classList.remove("active");
                }));
                artistPageButton.classList.add("active");
            }));
        }));
        const rankingButtons = document.querySelectorAll(".rankings__button");
        if (rankingButtons.length > 0) rankingButtons.forEach((rankingButton => {
        ...
        const itemBoards = document.querySelectorAll(".item-board");
        if (itemBoards.length > 0) itemBoards.forEach(((itemBoard, index) => {
            const itemBoardNumber = itemBoard.querySelector(".item-board__number");
            itemBoardNumber.innerHTML = index + 1;
        }));
        window["FLS"] = false;
        isWebp();
        menuInit();
